...
?>
  ...
  <?php
$JAside_Author_gonggao = new Typecho_Widget_Helper_Form_Element_Textarea(
    'JAside_Author_gonggao',
    NULL,
    NULL,
    '侧边栏公告',
    '介绍：用于修改侧边栏公告内容'
  );
  $JAside_Author_gonggao->setAttribute('class', 'joe_content joe_aside');
  $form->addInput($JAside_Author_gonggao);
